...
import { isFn, isArr } from '@ar/util';
...
const TempLabel = (_a) => {
    ...
    const { text = 'not text', style = {} } = props;
    return (jsxRuntime.jsx(Fragment, { children: jsxRuntime.jsxs("div", Object.assign({ style: style, onChange: () => {
                setName('new name');
            } }, { children: [text, " - ", name] }), void 0) }, void 0));
};
...
export { TempLabel, checkNoChinaChar, checkNum, checkNumberOrABC, decimalRule, getNumberRuleMessage, isImageByUrl, isVideoByUrl, maxlenRule, numberExcludeZeroRule, numberIncludeRule, rangeNumberRule, requiredRule, telphoneValidation };

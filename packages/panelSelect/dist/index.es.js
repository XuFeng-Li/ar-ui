...
const ARPanelSelect = (_a) => {
    ...
    if (props.dataSource && props.dataSource.length >= 1) {
        tempChildren = props.dataSource.map((ele, index) => {
            return jsxRuntime.jsx(Select.Option, Object.assign({ value: ele.value }, { children: ele.label }), index.toString());
        });
    }
    return (jsxRuntime.jsxs("div", Object.assign({ style: {
            ...
            justifyContent: "center"
                    ...
                    jsxRuntime.jsx("div", Object.assign({ style: { width: '100%' } }, { children: jsxRuntime.jsx(Select, Object.assign({ disabled: props.disabled, style: { width: '100%' }, onSelect: props.onSelect, onChange: props.onChange }, { children: tempChildren }), void 0) }), void 0),
                    props.addonAfter &&
                        jsxRuntime.jsx("div", Object.assign({ style: {
                                padding: "0 5px",
                                flex: "0 0 auto"

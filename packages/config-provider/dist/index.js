...
const ARConfigContext = f__default['default'].createContext({});
const ARConfigProvider = (_a) => {
    var props = __rest(_a, []);
    const { children, fetcher } = props;
    const config = { fetcher };
    return (jsxRuntime.jsx(ARConfigContext.Provider, Object.assign({ value: config }, { children: children }), void 0));
};
const ConfigConsumer = ARConfigContext.Consumer;

exports.ConfigConsumer = ConfigConsumer;
exports.default = ARConfigProvider;

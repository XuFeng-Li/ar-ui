...
const HouseType = (_a) => {
    ...
    return (React.createElement("span", null, `${bedroom}室${livingRoom}厅${kitchen}厨${bathroom}卫${balconyNum}阳台`));
};
...
const UpLoadInfo = (_a) => {
    ...
    if (typeof data === 'string')
        data = [data];
    return (React.createElement(Fragment, null, data.map((ele, i) => {
        ...
        return (React.createElement("a", { href: noHref ? 'javascript:void(0);' : ele, key: -i, rel: "noopener noreferrer" },
            React.createElement("img", { src: ele, alt: 'pic', width: '86px', style: Object.assign({}, extendStyle) })));
    })));
};
const VideoList = (_a) => {
    var props = __rest(_a, []);
    ...
    if (typeof list === 'string')
        list = [list];
    return (React.createElement(Fragment, null, list.map((ele, i) => {
        let extendStyle = Object.create({});
        ...
        extendStyle = Object.assign(Object.assign({}, extendStyle), style);
        return (React.createElement("video", { key: ele, style: Object.assign({ display: 'inline-block' }, extendStyle), src: ele, controls: true }));
    })));
};
const MainPic = (_a) => {
    var props = __rest(_a, []);
    ...
    if (url && isPrivate) {
        return (React.createElement("a", { href: url, rel: "noopener noreferrer", target: "_blank" },
            React.createElement("img", { src: `${url}`, alt: 'pic', height: '100px', width: '86px', style: Object.assign({}, style) })));
    }
    if (url) {
        return (React.createElement("a", { href: url, rel: "noopener noreferrer", target: "_blank" },
            React.createElement("img", { src: `${url}?x-oss-process=image/resize,m_fixed,h_${h},w_${w}`, alt: 'pic', height: '100px', width: '86px', style: Object.assign({}, style) })));
    }
    return (React.createElement("a", { href: 'javascript:void(0);', rel: "noopener noreferrer", target: "_blank" },
        React.createElement("img", { src: 'https://asman-img.oss-cn-hangzhou.aliyuncs.com/noPic_0e7bffac7958f603a8b37fe3cda07499.png', alt: 'pic', height: '100px', width: '86px', style: Object.assign({}, style) })));
};
const UploadPreview = (_a) => {
    ...
    return (React.createElement("div", Object.assign({}, rest, { style: Object.assign({}, style), className: 'poi tc', onClick: () => {
            showImagePreview();
        } }),
        params.type === 'video' ? React.createElement(VideoList, { list: list[0], style: Object.assign({}, innerStyle) }) :
            React.createElement(UpLoadInfo, { style: Object.assign({}, innerStyle), noHref: true, data: list[0] }),
        React.createElement("div", { className: 'bc tc' },
            "\u5171",
            list.length,
...
const UrlLink = (_a) => {
    ...
    return (React.createElement(Fragment, null, list.map(ele => {
        const url = simplifyFileName(ele, 1);
        return React.createElement("div", null,
            React.createElement("a", { href: ele, rel: "noopener noreferrer", target: "_blank" }, url));
    })));
};
const BlankLink = (_a) => {
    var props = __rest(_a, []);
    const { href, title } = props;
    return React.createElement("a", { href: href, rel: "noopener noreferrer", target: "_blank" }, title || href);
};
const TitleInfo = (_a) => {
    var props = __rest(_a, []);
    ...
    return React.createElement("span", Object.assign({}, rest, { title: info }), tit);
};
const BuleWrapper = (_a) => {
    ...
    if (!info)
        return null;
    return React.createElement("span", null,
        React.createElement("span", { style: { color } }, info),
        text);
};
const Bule = (_a) => {
    var props = __rest(_a, []);
    ...
    if (!info)
        return null;
    return React.createElement("span", { style: { color } }, info);
};
const Red = (_a) => {
    var props = __rest(_a, []);
...
const getColorWrapper = (props) => {
    const { info } = props;
    return info ? React.createElement(BuleWrapper, Object.assign({}, props)) : null;
};
const ShowMoreInfo = (props) => {
    ...
    return (React.createElement("span", null,
        ...
        " ",
        needSubstring ?
            React.createElement("span", { className: 'likeA', onClick: () => showMore() }, isShowAll() ? '收起' : '更多') : null,
        " "));
};
/**
 * xx幢xxx单元xxxx
...
const HouseDesc = (_a) => {
    ...
    return (React.createElement("span", null, `${buildingNo || '--'}幢${unitNo || '--'}单元${roomNo || '--'}室`));
};
const SomeRed = (props) => {
    ...
    return (React.createElement("span", null,
        start,
        React.createElement("span", { style: { color: 'red' } }, keyWord),
        end));
};
const LRInfo = (_a) => {
    var props = __rest(_a, []);
    ...
    if (!title) {
        return React.createElement("div", Object.assign({}, infoProps), info);
    }
    return (React.createElement("div", { className: 'df' },
        React.createElement("div", Object.assign({ className: 'g0' }, titleProps),
            title || ' -- ',
            "\u00A0",
            hasColon ? ':' : '',
            " \u00A0"),
        React.createElement("div", Object.assign({ className: 'df flex1' }, infoProps), info !== 0 ? info || '---' : info)));
};

...
const HouseType = (_a) => {
    ...
    return (jsxRuntime.jsx("span", { children: `${bedroom}室${livingRoom}厅${kitchen}厨${bathroom}卫${balconyNum}阳台` }, void 0));
};
...
const UpLoadInfo = (_a) => {
    ...
    if (typeof data === 'string')
        data = [data];
    return (jsxRuntime.jsx(f.Fragment, { children: data.map((ele, i) => {
...
const VideoList = (_a) => {
    ...
    if (typeof list === 'string')
        list = [list];
    return (jsxRuntime.jsx(f.Fragment, { children: list.map((ele, i) => {
            let extendStyle = Object.create({});
...
const UploadPreview = (_a) => {
    ...
    return (jsxRuntime.jsxs("div", Object.assign({}, rest, { style: Object.assign({}, style), className: 'poi tc', onClick: () => {
            ...
            jsxRuntime.jsxs("div", Object.assign({ className: 'bc tc' }, { children: ["\u5171", list.length, params.type === 'video' ? '个视频' : '张图片'] }), void 0)] }), void 0));
};
const UrlLink = (_a) => {
    var props = __rest(_a, []);
    let { list } = props;
    ...
    return (jsxRuntime.jsx(f.Fragment, { children: list.map(ele => {
...
const ShowMoreInfo = (props) => {
    ...
    const [showInfo, setShowInfo] = f.useState(initValue);
    ...
    return (jsxRuntime.jsxs("span", { children: [showInfo, " ", needSubstring ?
                jsxRuntime.jsx("span", Object.assign({ className: 'likeA', onClick: () => showMore() }, { children: isShowAll() ? '收起' : '更多' }), void 0) : null, " "] }, void 0));
};
/**
 * xx幢xxx单元xxxx
 * @param {*} props
...
const HouseDesc = (_a) => {
    ...
    return (jsxRuntime.jsx("span", { children: `${buildingNo || '--'}幢${unitNo || '--'}单元${roomNo || '--'}室` }, void 0));
};
const SomeRed = (props) => {
...
const BuildingArea = (_a) => {
    ...
    return jsxRuntime.jsxs("span", { children: [`${buildingName || '--'}${houseCode ? `${houseCode}户型` : ''}`, jsxRuntime.jsx("br", {}, void 0), " ", buildingNo ? `${buildingNo || '--'}栋${unitNo || '--'}单元${roomNo || '--'}室` : ''] }, void 0);
};

...
const ARImgRadio = (_a) => {
    var props = __rest(_a, []);
    const [value, setValue] = f.useState(props.initialValue);
    ...
    return (jsxRuntime.jsx("ul", Object.assign({ className: styles.radioList, style: Object.assign({}, style) }, { children: dataSource.map((item, index) => {
            ...
            return (jsxRuntime.jsxs("li", Object.assign({ className: radioItemClass, onClick: handleRadioClicked(item, index) }, { children: [jsxRuntime.jsx("div", Object.assign({ className: styles.radioItemImg }, { children: jsxRuntime.jsx(customimg.ARCustomImg, { src: img, ossProcess: ossProcess }, void 0) }), void 0),
                    jsxRuntime.jsx("div", Object.assign({ className: styles.radioItemDesc }, { children: jsxRuntime.jsx("span", { children: name }, name) }), void 0)] }), (10000 + index).toString()));
        }) }), void 0));
};

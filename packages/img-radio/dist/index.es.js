...
const ARImgRadio = (_a) => {
    ...
    return (jsxRuntime.jsx("ul", Object.assign({ className: styles.radioList, style: Object.assign({}, style) }, { children: dataSource.map((item, index) => {
            ...
            return (jsxRuntime.jsxs("li", Object.assign({ className: radioItemClass, onClick: handleRadioClicked(item, index) }, { children: [jsxRuntime.jsx("div", Object.assign({ className: styles.radioItemImg }, { children: jsxRuntime.jsx(ARCustomImg, { src: img, ossProcess: ossProcess }, void 0) }), void 0),

...
const ARInputNumber = (_a) => {
    ...
    return (React__default['default'].createElement("div", { className: styles.index, style: Object.assign(Object.assign({}, style), { height: 'small' === size ? '24px' : (('large' === size) ? '40px' : '32px') }) },
        !!addonBefore &&
            React__default['default'].createElement("div", { className: styles.addonBefore },
                React__default['default'].createElement("span", { style: {
                        fontSize: 'small' === size ? '14px' : (('large' === size) ? '16px' : '14px'),
                        fontWeight: 400,
                    } }, addonBefore)),
        React__default['default'].createElement(antd.InputNumber, Object.assign({ style: {
                width: '100%'

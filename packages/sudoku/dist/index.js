...
const ARSudoku = (_a) => {
    var props = __rest(_a, []);
    const [location, setLocation] = f.useState(() => {
        var _a, _b;
    ...
    const renderNode = () => {
        ...
        return (jsxRuntime.jsx("div", Object.assign({ className: styles.sudoku, style: Object.assign({}, bgPos) }, { children: rowArr.map((item, index) => {
                return (jsxRuntime.jsx("div", Object.assign({ className: styles["sudoku_row"] }, { children: colArr.map((itemCol, indexCol) => {
                        return (jsxRuntime.jsx("div", { className: styles["sudoku_col"], onClick: () => {

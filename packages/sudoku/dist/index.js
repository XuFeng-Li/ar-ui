...
const ARSudoku = (_a) => {
    ...
    const renderNode = () => {
        ...
        return (React__default['default'].createElement("div", { className: styles.sudoku, style: Object.assign({}, bgPos) }, rowArr.map((item, index) => {
            return (React__default['default'].createElement("div", { className: styles["sudoku_row"], key: item + index }, colArr.map((itemCol, indexCol) => {
                return (React__default['default'].createElement("div", { className: styles["sudoku_col"], key: itemCol + indexCol, onClick: () => {
